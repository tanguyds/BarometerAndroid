...
import com.example.tanguy.barometerandroid.api.interfaces.BarometerApi;
...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://localhost:44362/Account/Login/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();

        BarometerApi service = retrofit.create(BarometerApi.class);
    }
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            tokenRequest.setEmail(mEmailView.getText().toString());
            ...
            //service.getTokenAccess(TokenRequest);
        }
    }
